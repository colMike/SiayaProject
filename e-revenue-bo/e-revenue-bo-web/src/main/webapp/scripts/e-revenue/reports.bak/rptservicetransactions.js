...
angular.module('app.rptServiceTransaction', []).controller("rptServiceTransactionCtrl", ["$scope", "$filter", "serviceTxnSvc","memStatementSvc","$serviceTxnValid", "$rootScope", "blockUI", "logger", "$location","$http","$window", function ($scope, $filter, serviceTxnSvc,memStatementSvc,$serviceTxnValid, $rootScope, blockUI, logger, $location,$http,$window) {
    ...
    $scope.$watch("subSerSelect", function (newValue, oldValue) {
    	console.log("new"+newValue);
    	console.log("old"+oldValue);
        if ($serviceTxnValid(newValue)) {
            if (newValue != oldValue) {
            	//$scope.showSubService=false;
            	$scope.subSerSelect=newValue;
...
//       }
   ...
   $scope.exportPdfReport = function(mem) {
	   console.log(mem);
		...
		$scope.url = '/kcmc/reports?type=SD&eType=P&serId='+serviceId+'&subSerId='+subSerId+'&FrDt='+ FromDt + '&ToDt=' + ToDt;
	...
	$scope.exportExcelReport = function(mem) {
		...
		if(subSerId==null){
			...
			$scope.url = '/kcmc/reports?type=SD&eType=E&serId='+serviceId+'&subSerId='+subSerId+'&FrDt='+ FromDt + '&ToDt=' + ToDt;
	}
    ...
    compasRptServiceSvc.GetParentServices = function () {
        return $http({
            url: '/kcmc/rest/report/gtParentSer/',
            method: 'GET',
    ...
    compasRptServiceSvc.GetSubServices = function (parentServiceId) {
    	//console.log(parentServiceId);
        return $http({
            url: '/kcmc/rest/report/gtSubSer/'+parentServiceId,
            method: 'GET',
            headers: { 'Content-Type': 'application/json' },
    ...
    compasRptServiceSvc.GetServiceTxns = function () {
        return $http({
            url: '/kcmc/rest/report/gtServiceTxns/',
            method: 'GET',
            headers: { 'Content-Type': 'application/json' },
    ...
    compasRptServiceSvc.GetServiceDetailedTxn = function (service) {
        return $http({
            url: '/kcmc/rest/report/gtServiceTxnDetail/',
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            data:service
    ...
    compasRptServiceSvc.GateServiceDetailedTxn = function (service) {
        return $http({
            url: '/kcmc/rest/report/gateServiceTxnDetail/',
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            data:service
    ...
    compasRptServiceSvc.GateServiceSummary = function (service) {
        return $http({
            url: '/kcmc/rest/report/gateServiceSummary/',
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            data:service
    ...
    compasRptServiceSvc.UserServiceDetailedTxn = function (service) {
        return $http({
            url: '/kcmc/rest/report/userServiceTxnDetail/',
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            data:service
    ...
    compasRptServiceSvc.UserServiceSummary = function (service) {
        return $http({
            url: '/kcmc/rest/report/userServiceSummary/',
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            data:service
