...
angular.module('app.rptDeviceTransaction', []).controller("rptDeviceTransactionCtrl", ["$scope", "$filter", "deviceTxnSvc", "issueDeviceSvc","memStatementSvc","$deviceTxnValid", "$rootScope", "blockUI", "logger", "$location","$http","$window", function ($scope, $filter, deviceTxnSvc,issueDeviceSvc ,memStatementSvc,$deviceTxnValid, $rootScope, blockUI, logger, $location,$http,$window) {
   ...
   $scope.exportPdfReport = function(mem) {
	   ...
	   var deviceId=$scope.deviceSelect;
		...
		$scope.url = '/kcmc/reports?type=DTX&eType=P&FrDt='+ FromDt + '&ToDt=' + ToDt+ '&deviceId='+deviceId;
	...
	$scope.exportExcelReport = function(mem) {
		 ...
		 if (!$deviceTxnValid(mem.FromDt)) {
		  ...
		  var deviceId=$scope.deviceSelect;
			...
			$scope.url = '/kcmc/reports?type=DTX&eType=E&FrDt='+ FromDt + '&ToDt=' + ToDt+ '&deviceId='+deviceId;
	}
    ...
    compasRptStatementSvc.GetDeviceTxns = function () {
        return $http({
            url: '/kcmc/rest/report/gtDeviceTxns/',
            method: 'GET',
    ...
    compasRptStatementSvc.GetDeviceDetailedTxn = function (device) {
        return $http({
            url: '/kcmc/rest/report/gtDeviceTxnDetail/',
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            data:device
    ...
    compasRptStatementSvc.ServicePerDeviceSummary = function (device) {
        return $http({
            url: '/kcmc/rest/report/deviceServiceSummary/',
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            data:device
