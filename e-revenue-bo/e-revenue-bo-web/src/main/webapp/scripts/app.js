(function () {
    ...
    angular.module("app", ["ngRoute",
            ...
            "app.landapproval",
            "app.config",
            "app.rptServiceTransaction",
            "app.rptDeviceTransaction",
            "app.rptGateTransaction",
            "app.rptUserTransaction",
            "app.rptSummary",
            "app.permitsReport",
            "app.landRatesReport",
            "app.LandUpload",
            ...
            return $routeProvider.when("/", {
                ...
                templateUrl: "views/administration/usergroup.html"
            }).when("/user/users", {
                templateUrl: "views/administration/user.html"
            }).when("/user/profile", {
                templateUrl: "views/administration/myprofile.html"
            }).when("/user/sysconfig", {
                templateUrl: "views/administration/systemconfig.html"
            }).when("/masters/location", {
                templateUrl: "views/masters/location.html"
            }).when("/masters/subcounty", {
                templateUrl: "views/masters/subcounty.html"
            }).when("/masters/ward", {
                templateUrl: "views/masters/ward.html"
            }).when("/masters/market", {
                templateUrl: "views/masters/market.html"
            }).when("/masters/submarket", {
                templateUrl: "views/masters/submarket.html"
            }).when("/masters/permittype", {
                templateUrl: "views/masters/permittype.html"
            }).when("/sbp/application", {
                templateUrl: "views/sbp/application.html"
            }).when("/sbp/invoice", {
                templateUrl: "views/sbp/invoice.html"
            }).when("/sbp/invoiceapproval", {
                templateUrl: "views/sbp/invoiceapproval.html"
            }).when("/sbp/permit", {
                templateUrl: "views/sbp/permit.html"
            }).when("/sbp/permitrenewal", {
                templateUrl: "views/sbp/permitrenewal.html"
            }).when("/devices/device", {
                templateUrl: "views/devices/device.html"
            }).when("/masters/service", {
                templateUrl: "views/masters/service.html"
            }).when("/masters/entrypoint", {
                templateUrl: "views/masters/entrypoint.html"
            }).when("/masters/param", {
                templateUrl: "views/masters/param.html"
            }).when("/devices/issuedevice", {
                templateUrl: "views/devices/issuedevice.html"
            }).when("/masters/modifyservice", {
                templateUrl: "views/masters/modifyservice.html"
            }).when("/lr/registration", {
                templateUrl: "views/lr/registration.html"
            }).when("/lr/approval", {
                templateUrl: "views/lr/landapproval.html"
            }).when("/lr/landrenewal", {
                templateUrl: "views/lr/landrenewal.html"
            }).when("/lr/landinvoice", {
                templateUrl: "views/lr/landinvoice.html"
            }).when("/dashboard", {
                templateUrl: "views/others/dashboard.html"
            }).when("/404", {
                templateUrl: "views/others/404.html"
            }).when("/reports/summary", {
                templateUrl: "views/reports/summaryreport.html"
            }).when("/reports/z", {
                templateUrl: "views/reports/zreport.html"
            }).when("/reports/transactions", {
                templateUrl: "views/reports/rpttransaction.html"
            }).when("/reports/devices", {
                templateUrl: "views/reports/rptdevices.html"
            }).when("/reports/permits", {
            	templateUrl: "views/reports/rptpermits.html"
            }).when("/reports/landrates",{
            	templateUrl: "views/reports/rptlandrates.html"
            }).when("/lr/uploadLand", {
                templateUrl: "views/lr/uploadLandhtml.html"
            }).when("/lr/uploadPlot", {
                templateUrl: "views/lr/uploadPlot.html"
            })
...
.call(this), function () {
    ...
    angular.module("app.controllers", []).controller("AppCtrl", ["$scope", "$location", function ($scope, $location) {
        return $scope.isSpecificPage = function () {
            var path;
            return path = $location.path(), _.contains(["/404", "/pages/500", "/pages/login", "/login", "/pages/signin1", "/pages/signin2", "/pages/signup", "/pages/signup1", "/pages/signup2", "/lock"], path)
        }, $scope.main = {
            brand: "Smart Health Passport",
            name: "",
            scriptVersion: "1.1.0"
        }
